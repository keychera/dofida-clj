(ns minustwo.stage.pseudo.offscreen
  (:require
   ...
   [minustwo.gl.constants :refer [GL_ARRAY_BUFFER GL_FLOAT GL_STATIC_DRAW]]
...
(defn prep-offscreen-render [ctx width height tex-unit]
  (let [fbo-data        (texture/cast-fbo-spell ctx width height tex-unit)
